...
# Convert the ITRS coordinates to GCRS coordinates and save it to new arrays
x_gcrs = []
y_gcrs = []
z_gcrs = []
...
for i in range(array_size):
    ...
    obsloc_gcrs = obsloc_itrs.transform_to(coord.GCRS(obstime=t[i]))
...
str_time = np.datetime_as_string(t)
